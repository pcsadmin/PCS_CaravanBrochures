...
using Christoc.Modules.PCS_CaravanBrochures.Components;
...
namespace Christoc.Modules.PCS_CaravanBrochures
{
    ...
    /// 
    /// Because the control inherits from PCS_CaravanBrochuresModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Edit : PCS_CaravanBrochuresModuleBase
    {
